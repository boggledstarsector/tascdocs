    ...
    return (
        <div className="w-full lg:max-w-[1200px] lg:mx-auto">
            <section className="flex flex-col py-8 px-[2.5%] gap-4 text-base leading-relaxed">
                    ...
                    <table className="border-collapse text-sm">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td className="border px-3 py-2" style={{ borderColor: 'rgb(5, 250, 250)' }}>High</td>
                                <td className="border px-3 py-2" style={{ borderColor: 'rgb(5, 250, 250)' }}>Common / Plentiful</td>
                                <td className="border px-3 py-2" style={{ borderColor: 'rgb(5, 250, 250)' }}>— / Abundant</td>
                            </tr>
                ...
                <div>Several TASC buildings play essential roles in terraforming:</div>
                <ul className="list-disc list-inside pl-4">
                ...
                <div className="flex flex-col gap-1">
                    <div id="planet-type-changes"><span style={{ color: 'rgb(5, 250, 250)' }}>Planet Type Changes</span></div>
                    <ul className="list-disc list-inside pl-4">
                ...
                <div className="flex flex-col gap-1">
                    <div id="resource-improvements"><span style={{ color: 'rgb(5, 250, 250)' }}>Resource Improvements</span></div>
                    <ul className="list-disc list-inside pl-4">
                ...
                <div className="flex flex-col gap-1">
                    <div id="condition-modifications"><span style={{ color: 'rgb(5, 250, 250)' }}>Condition Modifications</span></div>
                    <ul className="list-disc list-inside pl-4">
