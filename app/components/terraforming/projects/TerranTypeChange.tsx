    ...
    return (
        <div className="w-full lg:max-w-[1200px] lg:mx-auto">
            <section className="flex flex-col py-8 px-[2.5%] gap-4 text-base leading-relaxed">
                ...
                <div className="md:max-w-[750px]"><span className="italic">Transforms a planet into a lush, Earth-like terran world with a breathable atmosphere, moderate climate, and abundant natural resources. Terran worlds are among the most desirable colonization targets in the Sector.</span></div>
                ...
                <div className="flex flex-col gap-1">
                    <div>Notes:</div>
                    <ul className="list-disc list-inside pl-4">
                        <li>Planets with low base water (barren, toxic) will need an <Link href="/docs/ismaras-sling" style={{ color: 'rgb(5, 250, 250)' }}>Ismara&apos;s Sling</Link> or <Link href="/docs/asteroid-processing" style={{ color: 'rgb(5, 250, 250)' }}>Asteroid Processing</Link> facility in the same system to reach high water level.</li>
                        <li>The very hot and very cold temperature conditions cannot be suppressed by the <Link href="/docs/stellar-reflector-array" style={{ color: 'rgb(5, 250, 250)' }}>Stellar Reflector Array</Link> by default, making those worlds ineligible. <span className="italic opacity-60">(The Stellar Reflector Array can optionally be configured to suppress very hot/very cold via LunaLib settings.)</span></li>
                        <li>If <Link href="/docs/mesozoic-park" style={{ color: 'rgb(5, 250, 250)' }}>Mesozoic Park</Link> is built on the colony, the <Link href="https://starsector.wiki.gg/wiki/Inimical_Biosphere" style={{ color: 'rgb(5, 250, 250)' }}>inimical biosphere</Link> condition will be re-added after the type change.</li>
