...
export default function SavannahTypeChange() {
    return (
        <div className="w-full lg:max-w-[1200px] lg:mx-auto">
            <section className="flex flex-col py-8 px-[2.5%] gap-4 text-base leading-relaxed">
                <h1 className="text-3xl font-bold">Savannah Type Change</h1>
                <div className="flex justify-start">
                    <img src="/images/planets/savannah.jpg" alt="Savannah planet texture" className="w-80 h-auto border" style={{ borderColor: 'rgb(5, 250, 250)' }} />
                </div>
                <div className="md:max-w-[750px]"><span className="italic">A warm planet where woodlands and grassy landscapes cover most of the landmass. Despite the majority of rainfall being confined to one of the local seasons, the biosphere flourishes and thrives.</span></div>
                ...
                <div className="flex flex-col gap-1">
                    ...
                    <ul className="list-disc list-inside pl-4">
                        ...
                        <li>Planet is not already a savannah world</li>
                ...
                <div className="flex flex-col gap-1">
                    <div>Results:</div>
                    <ul className="list-disc list-inside pl-4">
                        <li>Planet type changes to savannah</li>
                ...
                <div className="flex flex-col gap-1">
                    <div>Notes:</div>
                    <ul className="list-disc list-inside pl-4">
                        <li>Savannah worlds share the same base resources and terraforming requirements as <Link href="/docs/terraforming/terran-type-change" style={{ color: 'rgb(5, 250, 250)' }}>terran</Link> worlds — the planet type is purely cosmetic for terraforming purposes.</li>
