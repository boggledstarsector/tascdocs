            ...
            <section className="flex flex-col py-8 px-[2.5%] gap-4 text-base leading-relaxed">
                ...
                <div className="flex flex-col gap-1">
                    ...
                    <ul className="list-disc list-inside pl-4">
                        ...
                        <li>Planet has <Link href="https://starsector.wiki.gg/wiki/Market_condition#Hazard" style={{ color: 'rgb(5, 250, 250)' }}>extreme weather</Link></li>
                ...
                <div className="flex flex-col gap-1">
                    <div>Results:</div>
                    <ul className="list-disc list-inside pl-4">
                        <li>Removes <Link href="https://starsector.wiki.gg/wiki/Market_condition#Hazard" style={{ color: 'rgb(5, 250, 250)' }}>extreme weather</Link></li>
                    </ul>
                </div>
