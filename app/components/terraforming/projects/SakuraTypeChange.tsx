        ...
        <div className="w-full lg:max-w-[1200px] lg:mx-auto">
            <section className="flex flex-col py-8 px-[2.5%] gap-4 text-base leading-relaxed">
                ...
                <div className="flex flex-col gap-1">
                    <div>Results:</div>
                    <ul className="list-disc list-inside pl-4">
                        <li>Planet type changes to <span style={{ color: 'rgb(5, 250, 250)' }}>sakura</span></li>
                        ...
                        <li>Adds <span style={{ color: 'rgb(5, 250, 250)' }}>Ever-Blooming Forest</span> condition <span className="italic opacity-60"></span></li>
                ...
                <div className="flex flex-col gap-1">
                    <div>Notes:</div>
                    <ul className="list-disc list-inside pl-4">
                        <li>Sakura worlds share the same terraforming requirements and base resources as <Link href="/docs/terraforming/terran-type-change" style={{ color: 'rgb(5, 250, 250)' }}>terran</Link> worlds, with the addition of the <span style={{ color: 'rgb(5, 250, 250)' }}>Ever-Blooming Forest</span> condition.</li>
