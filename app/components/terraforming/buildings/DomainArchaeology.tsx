            ...
            <section className="flex flex-col py-8 px-[2.5%] gap-4 text-base leading-relaxed">
                ...
                <div className="flex flex-col gap-1">
                    ...
                    <ul className="list-disc list-inside pl-4">
                        ...
                        <li>Produces <Link href="https://starsector.wiki.gg/wiki/Domain-era_artifacts" style={{ color: 'rgb(5, 250, 250)' }}>Domain-era artifacts</Link>, with the supply amount scaled by the level of ruins on the host world.</li>
                    </ul>
                </div>
                <div className="flex flex-col gap-1">
                    ...
                    <div className="flex flex-col gap-2 pl-4">
                        <div className="flex items-center gap-2">
                            ...
                            <span>Increases <Link href="https://starsector.wiki.gg/wiki/Domain-era_artifacts" style={{ color: 'rgb(5, 250, 250)' }}>Domain-era artifacts</Link> production by <span style={{ color: 'rgb(255, 210, 0)' }}>1</span>, reduces demand by <span style={{ color: 'rgb(255, 210, 0)' }}>1</span> and reduces upkeep by <span style={{ color: 'rgb(255, 210, 0)' }}>25%</span>.</span>
                        </div>
                        <div className="flex items-center gap-2">
                ...
                <div><Link href="https://starsector.wiki.gg/wiki/Industry#Upgrading" style={{ color: 'rgb(5, 250, 250)' }}>Improvement bonus</Link>: Increases <Link href="https://starsector.wiki.gg/wiki/Domain-era_artifacts" style={{ color: 'rgb(5, 250, 250)' }}>Domain-era artifacts</Link> production by <span style={{ color: 'rgb(255, 210, 0)' }}>1</span>.</div>
                <div className="flex flex-col gap-1">
                    <div>Notes:</div>
                    <ul className="list-disc list-inside pl-4">
                        <li>Domain-era artifacts are demanded by a variety of other buildings in TASC. If you disable Domain Archaeology in the LunaLib settings, those buildings will cease to demand them.</li>
                        ...
                        <li><Link href="https://starsector.wiki.gg/wiki/Domain-era_artifacts" style={{ color: 'rgb(5, 250, 250)' }}>Domain-era artifacts</Link> are illegal in <Link href="https://starsector.wiki.gg/wiki/Luddic_Church" style={{ color: 'rgb(5, 250, 250)' }}>Luddic Church</Link> and <Link href="https://starsector.wiki.gg/wiki/Luddic_Path" style={{ color: 'rgb(5, 250, 250)' }}>Luddic Path</Link> space.</li>
                    </ul>
                </div>
