            ...
            <section className="flex flex-col py-8 px-[2.5%] gap-4 text-base leading-relaxed">
                ...
                <div className="flex flex-col gap-1">
                    ...
                    <ul className="list-disc list-inside pl-4">
                        ...
                        <li>Disabling this building in the <Link href="https://fractalsoftworks.com/forum/index.php?topic=25658.0" style={{ color: 'rgb(5, 250, 250)' }}>LunaLib</Link> settings will cause <Link href="/docs/terraforming#planet-type-changes" style={{ color: 'rgb(5, 250, 250)' }}>terraforming projects</Link> that require it to no longer require it.</li>
                    </ul>
                </div>
