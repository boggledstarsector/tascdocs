            ...
            <section className="flex flex-col py-8 px-[2.5%] gap-4 text-base leading-relaxed">
                ...
                <div className="flex flex-col gap-1">
                    ...
                    <div className="flex flex-col gap-2 pl-4">
                        <div className="flex items-center gap-2">
                            ...
                            <span>1 <span className="italic opacity-60">(only demanded when Domain-tech content and Domain Archaeology are enabled)</span></span>
                        </div>
                    </div>
                </div>
                <div className="flex flex-col gap-1">
                    ...
                    <ul className="list-disc list-inside pl-4">
                        ...
                        <li>Upkeep is multiplied by <span style={{ color: 'rgb(255, 210, 0)' }}>5</span> when the domain-era artifacts demand is unmet.</li>
                    </ul>
                </div>
                <div className="flex flex-col gap-1">
                ...
                <div className="flex flex-col gap-1">
                    ...
                    <ul className="list-disc list-inside pl-4">
                        ...
                        <li>Starsector distinguishes between <em>suppressing</em> a market condition and <em>removing</em> it. Suppression hides the condition&apos;s effects (hazard rating, supply/demand modifiers, and so on) for as long as the suppressing source is active, but the condition itself remains on the market. Removal deletes the condition outright. The Stellar Reflector Array only suppresses hot, cold, and poor light — it does not remove them. Because TASC&apos;s terraforming projects gate their availability on the planet&apos;s underlying temperature condition, building a Stellar Reflector Array will neutralize the hazard from hot or cold worlds but will not unlock terraforming projects that are otherwise blocked by those temperature conditions.</li>
                    </ul>
                </div>
