            ...
            <section className="flex flex-col py-8 px-[2.5%] gap-4 text-base leading-relaxed">
                ...
                <div className="flex flex-col gap-1">
                    ...
                    <ul className="list-disc list-inside pl-4">
                        <li>After <span style={{ color: 'rgb(255, 210, 0)' }}>200</span> days of uninterrupted operation, adds the <Link href="https://starsector.wiki.gg/wiki/Market_condition#Hazard" style={{ color: 'rgb(5, 250, 250)' }}>tectonic activity</Link> condition to the orbited planet and improves its <Link href="https://starsector.wiki.gg/wiki/Market_condition#Ore_deposits" style={{ color: 'rgb(5, 250, 250)' }}>ore</Link> and <Link href="https://starsector.wiki.gg/wiki/Market_condition#Rare_ore_deposits" style={{ color: 'rgb(5, 250, 250)' }}>rare ore</Link> availability by one tier.
                            <ul className="list-disc list-inside pl-6">
                                <li className="italic opacity-60">The cracking project length is configurable in <Link href="https://fractalsoftworks.com/forum/index.php?topic=25658.0" style={{ color: 'inherit' }}>LunaLib</Link> settings.</li>
                            </ul>
                        </li>
