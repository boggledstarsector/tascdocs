            ...
            <section className="flex flex-col py-8 px-[2.5%] gap-4 text-base leading-relaxed">
                ...
                <div className="flex flex-col gap-1">
                    ...
                    <ul className="list-disc list-inside pl-4">
                        ...
                        <li>Automatically closes and is removed if the planet is later terraformed to a type incompatible with Mesozoic Park (any installed AI core is returned to storage).</li>
                    </ul>
                </div>
                <div className="flex flex-col gap-1">
