                    ...
                    <ul className="list-disc list-inside pl-4">
                        <li>
                            ...
                            <ul className="list-inside pl-4 mt-0 mb-1" style={{ listStyleType: 'circle' }}>
                                <li>Has moderate ore and rare ore deposits and 100% hazard. <span className="italic opacity-60"> (ore deposits can be adjusted via LunaLib settings)</span></li>
                                <li>A single mining station can be constructed in each system. Only mining stations created via TASC count towards this limit (e.g. Derinkuyu Mining Station does not count). <span className="italic opacity-60"> (this limit can be increased via LunaLib settings)</span></li>
